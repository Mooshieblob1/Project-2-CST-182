...
I declare that I have used Google Gemini 2.5 Pro (large language model) as a tool to check for errors and bugs in my code and documentation, and for research purposes to understand different features and functionalities. The output generated by the AI was used as a guide and was critically reviewed, edited, and integrated into my work. All final content and ideas are my own.

This use of AI falls within the usage guidelines for AI tools as specified by SAE's academic integrity policies.
